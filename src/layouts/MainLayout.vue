<template>
  <q-layout view="lhh lpR fFf">
    <q-header :class="{ dimmed: loginDialog }" class="bg-primary text-white no-shadow">
      <q-toolbar class="q-my-sm navContainer ">
        <!-- TODO Fix toolbar title taking full width -->
        <q-toolbar-title>
          <q-btn unelevated no-caps flat size="lg" :ripple="false" :to="{ name: 'landing' }">
            Amt Viöl
          </q-btn>
        </q-toolbar-title>
        <div>
          <q-btn @click="loginDialog = true" color="yellow" unelevated class="mr-0 radius-6" no-caps>
    ...
    <signupDialog :dialogState="signupDialogState" @update="signupDialogState = $event" />
    <q-page-container>
      ...
      <div v-if="$router.currentRoute.path != '/'" class="bg-yellow-10 q-py-xl">
        <div class="row container">
          ...
          <div class="col self-center font-18">
            ...
            <q-btn @click="signupDialogState=true" color="blue" unelevated class="mr-0 radius-6" no-caps>
