    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <h1 class="font-50 text-weight-600 ">
            Datenschutzerklaerung
          </h1>
        </div>
        <div class="col-12 q-mb-xl privacyPolicy">
          <p>
          ...
          <p>
            ...
            spätestens 90 Tagen der Fall. Eine darüberhinausgehende Speicherung
          ...
          <p>
            Zustimmung des Benutzers: Cookies-Zustimmungspräferenzen und einen
            Cookie-Schlüssel. Die Frist beträgt ein Jahr.
            <br />Spracheinstellungen, Darkmode und andere technische
            Einstellungen sind im Local Storage gespeichert, Speicherdauer ist
            nicht befristet. <br />Technische Daten sind im Session Storage
            gespeichert, Speicherdauer beträgt aktive Benutzer Session Zeit.
          </p>
          ...
          <p>Name des Nutzers, E-mail Adresse, Stadtgemeinde</p>
          <p>
          ...
          <p>
            ...
            zuvor durch den Websitebesucher gewählte Nutzername gespeichert.
            Dies dient unserer Sicherheit, da wir für widerrechtliche Inhalte
            auf unserer Webseite belangt werden können, auch wenn diese durch
            Benutzer erstellt wurden.
          </p>
          <h3>Rechtsgrundlage:</h3>
          <p>
            Die Verarbeitung der als Kommentar eingegebenen Daten erfolgt auf
            der Grundlage eines berechtigten Interesses (Art. 6 Abs. 1 lit. f
            DSGVO).
          </p>
          <p>
          ...
          <p>
            ...
            Sachverhalt abschließend geklärt ist. Wir behalten uns die Löschung
            ohne Angaben von Gründen und ohne vorherige oder nachträgliche
            Information vor.
          </p>
          <p>
            ...
            zuständige Person und übermitteln den Link zu Ihrem Kommentar sowie
            zu Identifikationszwecken die bei der Erstellung des Kommentars
          ...
          <p>
            ...
            Ihnen keinen Zugang zu unserer Kommentarfunktion gewähren.
          </p>
          <p></p>
          <h2>Newsletter</h2>
          <h3>Art und Zweck der Verarbeitung:</h3>
          ...
          <p>
            ...
            Eingang der hiermit angeforderten Antwort. Weitere Daten werden
            nicht erhoben.
          </p>
          <h3>Rechtsgrundlage:</h3>
          <p>
