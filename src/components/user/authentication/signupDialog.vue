<template>
    <q-dialog v-model="$_options">
        <q-card class="radius-10 q-px-lg q-pt-lg q-pb-md" style="width: 570px; max-width: 80vw;">
            <q-card-section>
                <q-form ref="signupForm" class="q-gutter-lg">
                    <div class="row">
                        <div class="col-12">
                            <p class="q-mb-sm font-16">Email</p>
                            <q-input @keyup.enter="signup" outlined dense class="no-shadow input-radius-6"
                                v-model="form.email" :rules="[val => !!val || 'Field is required']" />
                        </div>
                    </div>
                    ...
                    <div class="row justify-center">
                        <div class="col-12 col-md-5 text-center">
                            <q-btn @click="signup" class="radius-10 full-width" padding="12px 12px" color="yellow"
                                text-color="black" unelevated :loading="isLoading">
                                Sign up<template v-slot:loading>

                                    <q-circular-progress indeterminate class="on-right" />
                                </template></q-btn>
                        </div>
                    </div>
                </q-form>
