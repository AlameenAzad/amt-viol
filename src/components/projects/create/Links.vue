        ...
        <div class="row items-baseline" :class="{ 'q-col-gutter-x-md': $q.screen.gt.sm }">
          <div class="col-11">
            <div class="row q-col-gutter-x-md">
              <div class="col-6">
                <q-input :rules="[val => !!val || 'Required']" outlined dense class="no-shadow input-radius-6"
                  placeholder="Titl" v-model="link.title" @input="onInput(index)" />
              </div>
              <div class="col-6">
                <q-input outlined dense class="no-shadow input-radius-6" placeholder="https://"
                  v-model.number="link.link" :rules="[val => !!val || 'Required']" @input="onInput(index)" />
              </div>
            </div>
          </div>
          <div class="col-1 ">
